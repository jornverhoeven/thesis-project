...
\textit{This scenario runs for a maximum of 20 minutes, or until no messages have been sent for 1 minute. This means that the scenario will end when the agents have stopped communicating with each other. This is done to prevent the scenario from running indefinitely.}
