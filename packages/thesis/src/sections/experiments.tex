...
The metrics we've defined can be categorized by effectiveness, efficiency, and timing. Effectiveness metrics measure how well the system is able to identify and mitigate risks. Efficiency metrics measure how well the system is able to do this with the least amount of resources. The timing metrics measure the time spent in a certain state. The metrics that are measured are shown in Table \ref{table:metrics-groups}.

\add{Fix the width of the table}
\begin{table}[H]
    \centering
    \begin{tabular}{l|l|l}
        \textbf{Effectiveness}            & \textbf{Efficiency}            & \textbf{Timing}          \\
        Total \# of risk identified       & Total \# of messages exchanged & Time spent auctioning      \\
        \# of remaining risks             & \# of adaptations              & Time spent adapting   \\
